...
get_msg_defs() -> [{{enum, 'Code'}, [{ok, 0}, {fail, 1}]}].
...
source_basename() -> "error_code.proto".
...
get_all_source_basenames() -> ["error_code.proto"].
...
%% functions.
get_all_proto_names() -> ["error_code"].
