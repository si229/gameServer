...
get_msg_defs() -> [{{enum, cmd}, [{msg_base, 0}, {msg_user, 1}]}].
...
find_enum_def(cmd) -> [{msg_base, 0}, {msg_user, 1}];
find_enum_def(_) -> error.


enum_symbol_by_value(cmd, Value) -> enum_symbol_by_value_cmd(Value).


enum_value_by_symbol(cmd, Sym) -> enum_value_by_symbol_cmd(Sym).


enum_symbol_by_value_cmd(0) -> msg_base;
enum_symbol_by_value_cmd(1) -> msg_user.


enum_value_by_symbol_cmd(msg_base) -> 0;
enum_value_by_symbol_cmd(msg_user) -> 1.
...
fqbin_to_enum_name(<<"cmd">>) -> cmd;
fqbin_to_enum_name(E) -> error({gpb_error, {badenum, E}}).


enum_name_to_fqbin(cmd) -> <<"cmd">>;
...
get_proto_by_enum_name_as_fqbin(<<"cmd">>) -> "msg";
